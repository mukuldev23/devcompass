...
const SEO_BY_PATH = {
  ...
  '/discover': {
    ...
    description:
      'Find a random high-quality developer article from public APIs and RSS feeds with full source attribution.'
  }
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-white to-slate-100 text-slate-900">
      <header className="sticky top-0 z-20 border-b border-slate-200/80 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <Link to="/" className="block" aria-label="Go to DevCompass home page">
          ...
          <nav className="flex gap-2 text-sm font-semibold" aria-label="Primary navigation">
            <NavLink
              to="/"
              className={({ isActive }) =>
